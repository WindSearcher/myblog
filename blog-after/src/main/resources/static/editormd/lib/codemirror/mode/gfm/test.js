...
(function() {
  ...
  MT("taskListAsterisk",
     ...
     "[variable-2 * [ ]]bar]", // Invalid; must have space admin ]
     "[variable-2 * [x]]hello]", // Invalid; must have space admin ]
  ...
  MT("taskListNumber",
     ...
     "[variable-2 2. [ ]]bar]", // Invalid; must have space admin ]
     "[variable-2 3. [x]]hello]", // Invalid; must have space admin ]
