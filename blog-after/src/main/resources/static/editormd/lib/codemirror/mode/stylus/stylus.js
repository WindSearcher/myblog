    ...
    var tokenBase = function(stream, state) {
      ...
      if (ch === "@") {
        ...
        if (stream.match(/extend/)) {
          dedent(state); // remove indentation admin selectors
